...
namespace AutoAssess.Data.Nessus
{
	public class NessusManager : IDisposable
	{
		...
		/// Scan ID.
		/// </param>
		public XmlDocument StopScan(Guid scanID)
		{
		...
		/// Represents errors that occur during application execution.
		/// </exception>
		public XmlDocument StopScan(Guid scanID, int seq)
		{
			if (!_session.IsAuthenticated)
				throw new Exception("Not authed.");
		...
		/// Scan ID.
		/// </param>
		public XmlDocument PauseScan(Guid scanID)
		{
		...
		/// Represents errors that occur during application execution.
		/// </exception>
		public XmlDocument PauseScan(Guid scanID, int seq)
		{
			if (!_session.IsAuthenticated)
				throw new Exception("Not authed.");
		...
		/// Scan ID.
		/// </param>
		public XmlDocument ResumeScan(Guid scanID)
		{
		...
		/// Represents errors that occur during application execution.
		/// </exception>
		public XmlDocument ResumeScan(Guid scanID, int seq)
		{
			if (!_session.IsAuthenticated)
				throw new Exception("Not authed.");
		...
		public XmlDocument GetReportHosts(string reportID, int seq)
		{
			...
			XmlDocument response = _session.ExecuteCommand("/report/hosts", options);
		...
		public XmlDocument GetPortsForHostFromReport(string reportID, string host, int seq)
		{
			...
			XmlDocument response = _session.ExecuteCommand("/report/ports", options);
